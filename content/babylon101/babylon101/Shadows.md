...
A bias that is too high can also be bad. If you are noticing that your shadows are smaller than they should be, or if the shape is distorted, then you may try reducing your bias:
```javascript
